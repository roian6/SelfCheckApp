...
import com.david0926.selfcheck.databinding.ActivityCheckOldBinding;
...
public class CheckActivityOld extends AppCompatActivity {
    ...
    private ActivityCheckOldBinding binding;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.action_reset) {
            ...
            builder.setPositiveButton("초기화", (dialogInterface, i) -> {
                ...
                startActivity(new Intent(CheckActivityOld.this, MainActivity.class));
                finish();
            });
