...
import com.david0926.selfcheck.databinding.ActivityMainOldBinding;
...
public class MainActivityOld extends AppCompatActivity {
        ...
        mCallSchool.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    Toast.makeText(MainActivityOld.this, "학교 이름을 검색하는 데 실패했습니다.", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    if (codeList.isEmpty() || codeList.size() != nameList.size()) failedSearch();
                        ...
                        DialogSearchBinding searchBinding = DataBindingUtil.inflate(LayoutInflater.from(MainActivityOld.this),
    ...
    private void failedSearch() {
        ...
        builder.setPositiveButton("메일 보내기", (dialogInterface, i) -> {
            ...
            if (intent.resolveActivity(getPackageManager()) != null)
                ...
                Toast.makeText(MainActivityOld.this, "이메일 앱이 없습니다. android-dev@kakao.com으로 남겨주세요.", Toast.LENGTH_LONG).show();
        });
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                try {
                    ...
                    if (result.equals("SUCCESS")) {
                        ...
                        SharedPreferenceUtil.putString(MainActivityOld.this, "user_key", key);
                        SharedPreferenceUtil.putString(MainActivityOld.this, "base_url", url);
                        ...
                        Toast.makeText(MainActivityOld.this, "학생 정보가 올바르지 않습니다.", Toast.LENGTH_SHORT).show();
                    }

                } catch (Exception e) {
                    Toast.makeText(MainActivityOld.this, "학생 정보를 불러오는 데 실패했습니다.", Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
    ...
    private void startCheck() {
        if (!SharedPreferenceUtil.getString(this, "user_key", "").equals("")
            ...
            Intent intent = new Intent(MainActivityOld.this, CheckActivity.class);
